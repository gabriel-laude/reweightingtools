...
@author: schaefej51
openmm simulation script for a biased simulation and reweighting
"""
...
# load structure, topology file and define platform (top or prmtop file)
inpcrd, prmtop, platform = get_inpcrdprmtopplatform(PlatformByNamen, 
                                                    None,
                                                    input_directory,
                                                    output_directory,
                                                    inpcrd_input,
...
# perturbation of dihedral angle phi
perturbation1 = CustomTorsionForce("-0.1*(8.985 + 3.122*cos(0.989*theta) + 0.959*cos(2*0.989*theta) + 7.742*cos(3*0.989*theta) + 0.095*sin(0.989*theta) + 0.047*sin(2*0.989*theta) + 0.002*sin(3*0.989*theta))")
perturbation1.addTorsion(0,1,5,8)
perturbation1.setForceGroup(1)
system.addForce(perturbation1)
